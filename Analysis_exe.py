...
# input_folder = 'D:\\Gut Imaging\\Videos\\Temp_UMAP\\Map_20200113_IndP\\'
input_folder = 'D:\\#Yinan\\AstC_NoFilter\\'
...
HDBSCAN_para_ls = [[10,3]]  # cluster parameter
# random_state_ls = [1,2,8,10,15,20,50,80,100,150,200,250,300,400,500,600,800]  # seed
random_state_ls = [2]  # seed
average_peak = 1
z_score_norm = 1
...
region_palatte_dict = {'R1': [255,102,102, 255],
                       'R2': [255,165,0, 255],
                       'R3': [76,166,76, 255],
                       'R4': [50,50,255, 255],
                       'R5': [0,0,0, 255]}
...
# cluster_label_name = '75_20_10_2cluster_label.txt'
...
# height = 8
# width = 4
# cluster_order = [6,7,5,10,4,11,2,3,9,8,1]
# stimulus_bar_y= -1
# stimulus_bar_lw= 8
