import pandas as pd
import numpy as np
from organized_Clustering_custom import UMAP_gen, UMAP_gen_paralle
import itertools
from DataOrganizer_Dh31 import organized_gen, data_plus_label, roiName2trace, parameters_mean_sem, parameters_mean_sem_cluster
...
# input_folder = 'D:\\Gut Imaging\\Videos\\svm\\Pros4\\'
input_folder = 'D:\\Gut Imaging\\Videos\\Temp_UMAP\\WT_CG13575_test\\'
# input_folder = 'D:\\Gut Imaging\\Videos\\Temp_UMAP\\AstC_noFil_kin\\'
# input_folder = 'D:\\Gut Imaging\\Videos\\Temp_UMAP\\noFilter_WT_CG13575\\'
...
organized = organized_gen(input_folder, raw=0, svm_model_name=svm_model_name, filter_ls=filter_ls, custom_peak=custom_peak)
exit()

####################################     Mean SEM Parameters Generator       ########################################
# # # *********************************************************************************************
# roi_names_file = 'Dh31_Live.txt'
# # *********************************************************************************************
#
...
#              dynamics_dff_peak = dynamics_dff_peak, dynamics_dff_peak_time = dynamics_dff_peak_time, dynamics_dff_prime_peak = dynamics_dff_prime_peak, dynamics_dff_prime_peak_time = dynamics_dff_prime_peak_time)
#
